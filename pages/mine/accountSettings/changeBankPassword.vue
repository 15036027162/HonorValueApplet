<template>
	<view class="changeBankPassword">
		...
		<view class="changeBankPassword_container">
	...
	export default {
		...
		methods:{
			...
			async retrievePasswordByType() {
				...
				const paramForm = {
					type:'1',//1银行卡登录忘记密码 2身份证号登录忘记密码
					bankCardNum:this.passwordForm.bankCard.bankCardNum,//身份证信息
